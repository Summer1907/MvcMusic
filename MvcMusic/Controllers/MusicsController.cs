...
namespace MvcMusic.Controllers
{
    public class MusicsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,ReleaseDate,Genre,Price,Rating,Verify")] Music music)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,ReleaseDate,Genre,Price,Rating,Verify")] Music music)
        {
            if (id != music.Id)
            {
                return NotFound();
